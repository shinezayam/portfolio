...
const translations: Translations = {
  ...
  "about.story.p1": { en: "Hi, I'm Shinezaya. I believe the digital world is not just code, pixels, and buttons — it's the story between people and technology. Making that story clearer and more delightful is both my work and my passion.", mn: "Сайн уу, би Шинэзаяа. Дижитал ертөнц бол зөвхөн код, пиксель, товч биш — харин хүн ба технологийн хоорондын түүх юм гэж би боддог. Тэр түүхийг илүү ойлгомжтой, илүү таатай болгох нь миний ажил, бас миний хүсэл мөрөөдөл." },
  "about.story.p2": { en: "For the past 3+ years as a UI/UX designer, I’ve been crafting meaningful experiences that are memorable and easy to understand. To me, great design is 'invisible'—it quietly guides users through their journey while solving real problems.", mn: "Сүүлийн 3+ жилд би UI/UX дизайнерын хувьд хэрэглэгчдэд сэтгэлд хоногшох, амархан ойлгогдох, утга учиртай туршлагуудыг бүтээж ирсэн. Миний хувьд сайн дизайн бол \"анзаарагддаггүй\" ч, хэрэглэгчийг аяллын туршид чимээгүйхэн чиглүүлж, бодит асуудлыг шийдэж байдаг зүйл." },
  "about.story.p3": { en: "Every project brings a new challenge, a new insight, and a new opportunity. When I’m not designing, I love exploring trends, trying new tools, or sharing learnings with the design community.", mn: "Төсөл бүр надад шинэ сорилт, шинэ ухаарал, шинэ боломж авчирдаг. Харин ажиллаагүй үедээ би шинэ чиг хандлага судалж, шинэлэг хэрэгсэл туршиж үзэх эсвэл дизайнерын хамт олонтойгоо туршлагаа хуваалцах дуртай." },
